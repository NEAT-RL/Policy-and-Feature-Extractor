...
#
LEARNING_RATE=0.01
DIRECTORY="EM_ALGORITHMS/policy-extractor/time_pilot/0.01"
...
python power_gradient_timepilot_discrete.py --learning_rate=$LEARNING_RATE
wait
...
cp time_pilot_* /vol/grid-solar/sgeusers/singhharm1/$DIRECTORY/$JOB_ID.$SGE_TASK_ID
