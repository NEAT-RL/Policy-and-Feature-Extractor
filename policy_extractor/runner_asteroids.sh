...
#
LEARNING_RATE=0.01
DIRECTORY="EM_ALGORITHMS/policy-extractor/asteroids/0.01"
...
python power_gradient_asteroids_discrete.py --learning_rate=$LEARNING_RATE
wait
...
cp asteroids* /vol/grid-solar/sgeusers/singhharm1/$DIRECTORY/$JOB_ID.$SGE_TASK_ID
#
echo "Ran through OK"
